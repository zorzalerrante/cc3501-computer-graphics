...
class ShaderProgramBase(ABC):
    ...
    @abstractmethod
    @classmethod
    def setupVAO(cls, gpuShape):
        raise NotImplementedError("setupVAO must be defined for every method")
...
class SimpleShaderProgram(ShaderProgramBase):
    vertex_shader = """
        #version 330
    ...
    def setupVAO(cls, gpuShape):
        ...
        position = glGetAttribLocation(cls.shaderProgram, "position")
        glVertexAttribPointer(position, 3, GL_FLOAT, GL_FALSE, 24, ctypes.c_void_p(0))
        glEnableVertexAttribArray(position)
        
        color = glGetAttribLocation(cls.shaderProgram, "color")
...
class SimpleTextureShaderProgram(ShaderProgramBase):
    vertex_shader = """
        #version 330
    ...
    def setupVAO(cls, gpuShape):
        ...
        texCoords = glGetAttribLocation(cls.shaderProgram, "texCoords")
...
class SimpleTransformShaderProgram(ShaderProgramBase):
    vertex_shader = """
        #version 330
...
class SimpleTextureTransformShaderProgram(ShaderProgramBase):
    vertex_shader = """
        #version 330
...
class SimpleModelViewProjectionShaderProgram(ShaderProgramBase):
...
class SimpleTextureModelViewProjectionShaderProgram(ShaderProgramBase):
