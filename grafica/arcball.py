...
class Arcball(object):
    ...
    def drag(self, point):
        ...
        if self._state == Arcball.STATE_ROTATE:
            ...
            #)
            x_rot_mat = tr.translate(*target) @ tr.rotationY(x_angle) @ tr.translate(*-target)
            y_angle = dy / mindim
            #y_rot_mat = transformations.rotation_matrix(
            #    y_angle, x_axis, target
            #)
            y_rot_mat = tr.translate(*target) @ tr.rotationX(y_angle) @ tr.translate(*-target)
        ...
        # Interpret drag as a roll about the camera axis
            ...
            rot_mat = tr.translate(*target) @ tr.rotationZ(theta) @ tr.translate(*-target)
    ...
    def rotate(self, azimuth, axis=None):
        ...
        x_rot_mat = tr.translate(*target) @ tr.rotationY(azimuth) @ tr.translate(*-target)
